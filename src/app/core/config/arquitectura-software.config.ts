...
export const ARQUITECTURA_SOFTWARE_CONFIG: Concept[] = [
  // --- Parte I: Fundamentos --
  {
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/1e3a8a/ffffff?text=Arquitectura'
  },
  {
    id: 2,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/075985/ffffff?text=Importancia'
  },
  {
    id: 3,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/0f766e/ffffff?text=Objetivos'
  },
  {
    id: 4,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/047857/ffffff?text=Propositos'
  },
  {
    id: 5,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/166534/ffffff?text=Calidad'
  },
  {
    id: 6,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/3f6212/ffffff?text=Rendimiento'
  },
  {
    id: 7,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/854d0e/ffffff?text=Escalabilidad'
  },
  {
    id: 8,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/9a3412/ffffff?text=Disponibilidad'
  },
  {
    id: 9,
    ...
    category: 'Parte I',
    imageUrl: 'https://placehold.co/800x450/9f1239/ffffff?text=Seguridad'
  },
  ...
  // --- Parte II: Arquitectura y Negocio ---
  {
    ...
    category: 'Parte II',
    imageUrl: 'https://placehold.co/800x450/701a75/ffffff?text=Negocio'
  },
  {
    id: 11,
    ...
    category: 'Parte II',
    imageUrl: 'https://placehold.co/800x450/86198f/ffffff?text=Drivers'
  },
  {
    id: 12,
    ...
    category: 'Parte II',
    imageUrl: 'https://placehold.co/800x450/4338ca/ffffff?text=Estrategia'
  },
  {
    id: 13,
    ...
    category: 'Parte II',
    imageUrl: 'https://placehold.co/800x450/3730a3/ffffff?text=Impacto'
  },
  {
    id: 14,
    ...
    category: 'Parte II',
    imageUrl: 'https://placehold.co/800x450/1d4ed8/ffffff?text=Modelos'
  },
  {
    id: 15,
    ...
    category: 'Parte II',
    imageUrl: 'https://placehold.co/800x450/0369a1/ffffff?text=Otros+modelos'
  },
  ...
  // --- Parte III: El Arquitecto de Software ---
  {
    ...
    category: 'Parte III',
    imageUrl: 'https://placehold.co/800x450/0e7490/ffffff?text=Arquitecto'
  },
  {
    id: 17,
    ...
    category: 'Parte III',
    imageUrl: 'https://placehold.co/800x450/0f766e/ffffff?text=Habilidades'
  },
  {
    id: 18,
    ...
    category: 'Parte III',
    imageUrl: 'https://placehold.co/800x450/15803d/ffffff?text=Decisiones'
  },
  {
    id: 19,
    ...
    category: 'Parte III',
    imageUrl: 'https://placehold.co/800x450/4d7c0f/ffffff?text=Monolito+vs+Microservicios'
  },
];